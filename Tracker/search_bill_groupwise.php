...
<tr>
<td width="50%">   
<form action="client_billing.php" method="post" name="form" id="form" onSubmit="return ValidatePAN()">
...
<td width="50%">
<form action="bill_month.php" method="post" name="form" id="form" onSubmit="return ValidatePAN()">
