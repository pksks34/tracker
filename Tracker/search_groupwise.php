...
<tr>
<td width="50%">   
<form action="group.php" method="post" name="form" id="form" onSubmit="return ValidatePAN()">
<p align="center">Enter to see Groupwise:<input type="text" name="gp" value="" placeholder="enter group exist group name here" required/></p>
<p align="center"><input type="submit" name="submit" value="Submit"/></p>
</form>
</td>
<td width="50%">
<form action="month.php" method="post" name="form" id="form" onSubmit="return ValidatePAN()">
