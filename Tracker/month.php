...
<div class="container">
  ...
  <div class="well" align="center" style="font-size:30px; color:yellow; background-color:blue; width:100%;">Repot According to Month</div>
  
      
</div>

 <div class="container">
  <h2 align="center">Group:<?php echo $_POST['month'];?></h2>
  <table class="table">
    <thead>
      <tr>
...
include("config.php");
$gr=$_POST["month"];
$sql = "SELECT * from indexing where month='$gr'";
