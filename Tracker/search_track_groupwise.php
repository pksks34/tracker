...
<tr>
<td width="50%">   
<form action="client.php" method="post" name="form" id="form" onSubmit="return ValidatePAN()">
...
<td width="50%">
<form action="track_month.php" method="post" name="form" id="form" onSubmit="return ValidatePAN()">
